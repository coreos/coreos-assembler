...
func (om *machine) WaitForSoftReboot(timeout time.Duration, oldBootTimestamp string) error {
	return platform.WaitForMachineSoftReboot(om, om.journal, timeout, oldBootTimestamp)
}
