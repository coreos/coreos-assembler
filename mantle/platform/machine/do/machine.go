...
func (dm *machine) WaitForSoftReboot(timeout time.Duration, oldBootTimestamp string) error {
	return platform.WaitForMachineSoftReboot(dm, dm.journal, timeout, oldBootTimestamp)
}
