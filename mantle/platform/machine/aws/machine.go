...
func (am *machine) WaitForSoftReboot(timeout time.Duration, oldBootTimestamp string) error {
	return platform.WaitForMachineSoftReboot(am, am.journal, timeout, oldBootTimestamp)
}
