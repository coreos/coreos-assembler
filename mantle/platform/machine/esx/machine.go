...
func (em *machine) WaitForSoftReboot(timeout time.Duration, oldBootTimestamp string) error {
	return platform.WaitForMachineSoftReboot(em, em.journal, timeout, oldBootTimestamp)
}
