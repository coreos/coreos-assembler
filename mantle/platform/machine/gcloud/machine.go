...
func (gm *machine) WaitForSoftReboot(timeout time.Duration, oldBootTimestamp string) error {
	return platform.WaitForMachineSoftReboot(gm, gm.journal, timeout, oldBootTimestamp)
}
