...
import (
	...
	"github.com/coreos/butane/config/openshift/v4_12_exp/result"
...
// ToConfigBytes translates from a v4.12 Butane config to a v4.12 MachineConfig or a v3.4.0 Ignition config. It returns a report of any errors or
